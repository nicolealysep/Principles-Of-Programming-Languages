error id: file://<HOME>/Library/CloudStorage/OneDrive-UCB-O365/Spring%202026/CSCI%203155-100%20Principles%20of%20Programming%20Languages/miniproject1/project1_NicoleP/src/main/scala/edu/colorado/csci3155/project1/StackMachineCompiler.scala:scala/package.List.
...
object StackMachineCompiler {
    ...
    def compileToStackMachineCode(e: Expr): List[StackMachineInstruction] = {
        e match{
            ...
            case And(e1, e2) => {
                compileToStackMachineCode(e1)++
                @@List(ICondSkip(length(e2_code)+1))++
                compileToStackMachineCode(e2)++
                List(ISkip(1))++
